    ...
    class Perfil extends Controller{
        ...
        function actualizarUsuario(){
            ...
            if (empty($_POST['nombre'])) {
                ...
                header("location: http://allgame.epizy.com/perfil/verUsuario/" . $usuario. "/?fracasoModificarNombreVacio");
                die();

            } else if(!preg_match('/^[A-ZÁÉÍÓÚ][a-záéíóú]*$/', $nombre)){
            
                header("location: http://allgame.epizy.com/perfil/verUsuario/" . $usuario . "/?fracasoModificarNombre");
                die();
            ...
            if (empty($_POST['apellidos'])) {
                ...
                header("location: http://allgame.epizy.com/perfil/verUsuario/" . $usuario . "/?fracasoModificarApellidosVacio");
                die();
                ...
                header("location: http://allgame.epizy.com/perfil/verUsuario/" . $usuario . "/?fracasoModificarApellidos");
                die();
            ...
            if (empty($_POST['email'])) {
                ...
                header("location: http://allgame.epizy.com/perfil/verUsuario/" . $usuario . "/?fracasoModificarEmailVacio");
                die();

            }else if(!preg_match('/^[-0-9a-zA-Z.+]+@[-0-9a-zA-Z.+_]+(\.[a-zA-Z]{2,4})$/', $email)){

                header("location: http://allgame.epizy.com/perfil/verUsuario/" . $usuario . "/?fracasoModificarEmail");
                die();
            ...
            if (empty($_POST['fecnac'])) {
                ...
                header("location: http://allgame.epizy.com/perfil/verUsuario/" . $usuario . "/?fracasoModificarFecnacVacio");
                die();
                

            } else if( $fecnac > $fecha_actual || $fecnac == $fecha_actual ){

                header("location: http://allgame.epizy.com/perfil/verUsuario/" . $usuario . "/?fracasoModificarFecnac");
                die();

            }else if($fecnac < $fecha_antigua){

                header("location: http://allgame.epizy.com/perfil/verUsuario/" . $usuario . "/?fracasoModificar2Fecnac");
                die();
            ...
            if($falloNombre==false && $falloApellidos==false && $falloEmail==false && $falloFecha == false){
                ...
                header('location: http://allgame.epizy.com/perfil/?exitoActualizar');
