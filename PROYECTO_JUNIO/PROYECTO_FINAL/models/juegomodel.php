<?php
    ...
    class JuegoModel extends Model{
        ...
        public function insertarFavoritos($nombre, $usuario){
            ...
            if($TRegistros > 0){
                header("location:http://localhost/PROYECTO_JUNIO/PROYECTO_FINAL/juego/?fracasoFavoritos");
            } else {
                ...
                $consulta3->execute();
                header("location:http://localhost/PROYECTO_JUNIO/PROYECTO_FINAL/juego/?exitoFavoritos");
            }
