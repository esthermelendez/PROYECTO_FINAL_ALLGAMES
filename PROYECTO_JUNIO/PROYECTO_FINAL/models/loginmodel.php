            ...
            try{
                ...
                if ($registrosEncontrados !=0) {
                    ...
                    if($this->session->getStatus() == 2){
                        header("location:http://localhost/PROYECTO_JUNIO/PROYECTO_FINAL/juego") ;
                    }else if($this->session->getStatus() == 1)
                    echo "Acceso denegado";
                    
                } else{
                    header("location:http://localhost/PROYECTO_JUNIO/PROYECTO_FINAL/login/?fracasoLogin") ;
