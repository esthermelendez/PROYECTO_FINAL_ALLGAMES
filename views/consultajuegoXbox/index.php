            ...
            <div class="containerJuegos">
                ...
                <div id="main">
                        ...
                        <?php
                            ...
                            if ($total_paginas > 1) {
                                for ($i=1;$i<=$total_paginas;$i++) {
                                    echo '<ul class="pagination pagination-sm"><li ><a  style="color: black" style:"text-decoration:none" href="'. constant("URL").'juegoxbox/render/?pagina='.$i.'">'.$i.'</a></li></ul>  ';                                }
                            }
                    ...
                    <?php
                        ...
                        foreach($this->juegoxbox as $row){
                            $juegoxbox = new JuegoXbox();
                            $juegoxbox = $row; 
                    ...
                    <div class="row-text-center">
                        <div class="col-sm-4">
                            <div class="thumbnail">
                                ...
                                <img id="caratula" src="<?= $juegoxbox->imagen; ?>">
                                
                                <p><strong><?php echo $juegoxbox->nombre; ?></strong></p>

                                <a href="<?php echo constant("URL"). "juegodetalle/verJuego/" . $juegoxbox->nombre ?>">
